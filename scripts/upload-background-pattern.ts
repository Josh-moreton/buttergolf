...
async function uploadBackgroundPattern() {
  try {
    ...
    const imagePath = join(process.cwd(), 'packages/assets/images/image-backgrounds/Butter Golf_Brand identity creation_Bacground pattern 1_BI81_V1.png');
    ...
    console.log('   The upload API will automatically apply it as background after removing the original background.');
