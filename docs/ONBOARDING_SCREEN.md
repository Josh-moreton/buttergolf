...
const images = [
  {
    id: "club",
    source: require("../../../assets/carousel/club.jpg"),
    label: "Golf Club",
  },
  {
    id: "ball",
    source: require("../../../assets/carousel/ball.jpg"),
    label: "Golf Ball",
  },
  {
    id: "bag",
    source: require("../../../assets/carousel/bag.jpg"),
    label: "Golf Bag",
  },
  {
    id: "feet",
    source: require("../../../assets/carousel/feet.jpg"),
    label: "Golf Shoes",
  },
  {
    id: "scooter",
    source: require("../../../assets/carousel/scooter.jpg"),
    label: "Golf Cart",
  },
  {
    id: "accessory",
    source: require("../../../assets/carousel/accessory.jpg"),
    label: "Accessory",
  },
];
```
