...
export function ProductDetailScreen({
  ...
  if (loading) {
    return (
      <Column flex={1} backgroundColor="$background" alignItems="center" justifyContent="center">
  ...
  if (error || !product) {
    return (
      <Column flex={1} backgroundColor="$background" padding="$4" gap="$4">
        <Button {...backLink} size="md" tone="outline" icon={ArrowLeft}>
          Back to Products
        </Button>
    ...
    <ScrollView flex={1} backgroundColor="$background">
      <Column gap="$4">
        ...
        <Column padding="$4" gap="$4">
          <Button {...backLink} size="sm" tone="ghost" icon={ArrowLeft} alignSelf="flex-start">
            Back
          </Button>
