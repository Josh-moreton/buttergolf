            ...
            >
                ...
                <Column gap="$sm" marginTop="$lg" width="100%">
                    <Row gap="$sm" alignItems="center">
                        <Text size="xl">✓</Text>
                        <Text size="md" color="$text">List items in under 60 seconds</Text>
                    </Row>
                    <Row gap="$sm" alignItems="center">
                        <Text size="xl">✓</Text>
                        <Text size="md" color="$text">No listing fees - only pay when you sell</Text>
                    </Row>
                    <Row gap="$sm" alignItems="center">
                        <Text size="xl">✓</Text>
                        <Text size="md" color="$text">Secure payments and buyer protection</Text>
                    </Row>
                    <Row gap="$sm" alignItems="center">
                        <Text size="xl">✓</Text>
                        <Text size="md" color="$text">Reach a community of passionate golfers</Text>
                    </Row>
                </Column>
            </Column>
        </Column>
