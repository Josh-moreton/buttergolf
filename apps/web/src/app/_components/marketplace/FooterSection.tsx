...
export function FooterSection() {
  return (
    <YStack paddingVertical="$8" borderTopWidth={1} borderColor="$border">
      <YStack maxWidth={1200} marginHorizontal="auto" paddingHorizontal="$4" {...{ gap: "xl" as any }}>
        <XStack {...{ gap: "$2xl" as any }} $sm={{ flexDirection: "column" }} $md={{ flexDirection: "row" }}>
          <YStack flex={1} {...{ gap: "xs" as any }}>
