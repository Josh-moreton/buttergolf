...
export interface UserButtonWithMenuProps {
  size?: "default" | "large";
}
 ...
 */
export default function UserButtonWithMenu({ size = "default" }: UserButtonWithMenuProps) {
  const avatarClass = size === "large" ? "w-12 h-12" : "w-10 h-10";
